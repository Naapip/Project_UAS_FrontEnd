...
app.controller("TravelTipsController", function ($scope) {
  $scope.tips = [
    {
      title: "Pack Smart",
      description: "Pelajari cara berkemas secara efisien dengan barang bawaan minimal untuk perjalanan apa pun.",
    ...
    },
    {
      ...
      description: "Mengapa asuransi perjalanan penting untuk perjalanan bebas kekhawatiran.",
      image: "/images/home/travel-insurance.jpg",
      link: "https://www.cekpremi.com/blog/manfaat-travel-insurance/",
    },
    {
      title: "Local Culture",
      description: "Tips untuk menghormati budaya dan tradisi lokal saat bepergian.",
      image: "/images/home/local-culture.jpg",
      link: "https://sacredfootprints.com/authentic-local-culture-in-indonesia/",
    },
    {
      title: "Money Management",
      description: "Pelajari cara menangani pertukaran mata uang dan hindari pengeluaran berlebihan.",
    ...
    {
      title: "Safety First",
      description: "Tetap aman dengan kiat-kiat keamanan perjalanan yang penting ini.",
    ...
    },
    {
      ...
      description: "Manfaatkan petualangan solo Anda sebaik-baiknya dengan kiat-kiat praktis ini.",
